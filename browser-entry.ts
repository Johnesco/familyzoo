/**
 * Browser Entry Point for A progressive Sharpee tutorial - explore Willowbrook Family Zoo.
 *
...
async function start(): Promise<void> {
  console.log('=== A progressive Sharpee tutorial - explore Willowbrook Family Zoo. BROWSER START ===');
